...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
            <title>Carpooling Script Installation v 3.0</title>
            <!-- must have -->
        ...
        <div class="container-main margintop140 marginbottom40">
            <div class="container">
                <div class="width960 center">
                    ...
                    <?php endif; ?>
                    <h2 class="size40 bold">Installing Carpooling Script v 3.0</h2>
                    <?php echo form_open('/'); ?>			
...
<?php echo form_input(array('class' => 'span8', 'placeholder' => 'Google App Secret Id', 'name' => 'google_app_secret_id', 'value' => set_value('google_app_secret_id'))); ?>
                                ...
                                <li>
<?php echo form_input(array('class' => 'span8', 'placeholder' => 'Google Map App key', 'name' => 'google_api_key', 'value' => set_value('google_api_key'))); ?>
                                </li>
                            </ul>
                        </div>
                        <!-- End Left -->				
                    ...
                    <div class="para">
                        <p>The Step-6 of installation guide will hold good only for first version. This section has been given for the purpose of testing, using a sample data, which is one time only. Since you will be downloading version  3.0  and not the first version, do not select this option.</p> 
                    </div>
                    <div class="row fleft padding10 blue-bg marginbottom40">            
                        <div class="padding10 fleft width100">
                            <ul class="con-main">						
