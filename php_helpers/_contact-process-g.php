...
$address = "oohfiro@gmail.com,duncan@sparrowapp.co,alex@sparrowapp.co";
...
echo '<div class="galert galert-success alert-dismissible" role="alert">Great! You`re all set to join us on our journey</div>';
