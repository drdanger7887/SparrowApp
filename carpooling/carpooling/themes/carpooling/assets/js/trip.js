                        ...
                        $.ajax({
                            ...
                            success: function (json) {
                                if (json.result == 0) {
                                   ...
                                   // window.location = baseurl + 'addtrip'; /// Geka
                                    window.location = baseurl + 'community/site/' + commslug;
                                }
...
function initialize1() {
    ...
    if (multicountry != '') {
        for (countrry in multicountry) { 
            var options = {componentRestrictions: {country: multicountry[countrry]}};
