...
function filter_result(url) {
	...
	var Return = $( "input:radio[name=returntype]:checked" ).val()?$( "input:radio[name=returntype]:checked" ).val():'';
        var Passenger_type = $( "input:radio[name=passenger_type]:checked" ).val()?$( "input:radio[name=passenger_type]:checked" ).val():'';
        var Vechiclecomfort = $( "input:radio[name=vechiclecomfort]:checked" ).val()?$( "input:radio[name=vechiclecomfort]:checked" ).val():'';
        //alert(Gender);
