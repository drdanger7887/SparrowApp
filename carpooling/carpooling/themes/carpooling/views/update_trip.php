                                ...
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">     
                                    <div class="trip-lft">
                                        ...
                                        <div class="fleft width100 margintop20">
                                            ...
                                            <input type="text" class="fleft width100 padding10" placeholder="<?php echo lang('arrival_poit'); ?>"  name="txtdestination" id="txtdestination"  value="<?= $txtdestination ?>"/>
                                        ...
                                        <div class="fleft width100 margintop20"> 
                                            ...
                                            <span class="size14 bold row"><span class="mandatory">*</span> <?php echo lang('Passanger_type'); ?></span>
                                            <p class="row bold paddingtop10"> 
                                                <?php print_r($passenger_type); die;?>
                                                <span class="fleft size14"> <input type="checkbox" name="passenger_type"  id="female" value="1" <?php if(passenger_type) $checked == 1?>/><?php echo lang('female'); ?></span>
                                                <span class="fleft size14 marginleft30"> <input type="checkbox" name="passenger_type" id="male" value="2" <?php if(passenger_type) $checked == 2?>/><?php echo lang('male'); ?></span>
                                                <span class="fleft size14 marginleft30"> <input type="checkbox" name="passenger_type" id="both" value="3" <?php if(passenger_type) $checked == 3?>/><?php echo lang('both'); ?></span>
                                            </p><br>
                                        ...
                                        <div class="fleft width100 margintop20">
                                            <ul class="trp-step">
                                                <li id="departure"> 
                                                    ...
                                                    echo form_dropdown('fhh', $options, set_value('fhh', $fhh), ' id="fhh" class="fleft padding10 " onchange="clearnow();"');
                                                    ?>
                                        ...
                                        <div class="fleft width100 margintop20">
                                            ...
                                            <?php
                                            $data = array('name' => 'avail_seats', 'id' => 'avail_seats', 'class' => 'fleft width100 padding10 row', 'placeholder' => lang('available_seat'), 'value' => set_value('avail_seats', $avail_seats));
