...
<div class="header pst_cnt">
	...
	?>
		...
		<?php endif;?>
                  ...
                  <h3><?php echo lang('add_vechile');?></h3>
                ...
                <div class="ad_vhl">
                	<span><?php echo lang('vehicle_number'); ?></span>
                    <input type="text" placeholder="<?php echo lang('vehicle_number'); ?>" name="txtvechicle" id="txtvechicle" value="<?=$txtvechicle?>" />
                </div>
                 <div class="ad_vhl">
                	<span><?php echo lang('attach_file'); ?> </span>
...
<input type="hidden" value="1" name="submitted" />
                	<label> <input type="Submit" value="<?php echo lang('submit'); ?>Submit" class="search_but"> </label>
                    </form>
                	</div>
            </div>
            <!-- End Project Left -->
