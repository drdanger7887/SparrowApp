...
<div id="content-wrapper">
    <div class="row">
        <div class="col-lg-12">
            ...
            <p style="color: green"><b> Kindly note that, the given list of currencies include only those currencies as listed by Paypal. You may choose from those currencies only.</b></p>
        </div>
