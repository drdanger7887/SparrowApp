                            ...
                            <ul class="nav navbar-nav pull-left">
                                ...
                                <li class="dropdown hidden-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="item">
                                            <a href="<?php echo $admin_url; ?>comport_level">
                                ...
                                <li class="dropdown hidden-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="item">
                                            <a href="<?php echo $admin_url; ?>payment/success">
                                                <i class="fa fa-check"></i> 
                                               Success Payments
                                            </a>
                                        </li>
                                        <li class="item">
                                            <a href="<?php echo $admin_url; ?>payment/failed">
                                                <i class="fa fa-times"></i> 
                                                Failed Payments
                                            </a>
                                        </li>
                                        <li class="item">
                                            <a href="<?php echo $admin_url; ?>payment/consolidate">
                                                <i class="fa fa-inbox"></i> 
                                        ...
                                        <li class="item">
                                            <a href="<?php echo $admin_url; ?>admin/payment">
                                ...
                                <li class="dropdown hidden-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="item">
                                            <a href="<?php echo $admin_url; ?>admin/social_media">
                                                <i class="fa fa-share-alt-square"></i> 
                                               Social Media Page Share.
                                            </a>
                                        </li>
                            ...
                            <ul class="nav navbar-nav pull-right">
                                ...
                                <li class="dropdown profile-dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a href="<?php echo base_url('admin/admin/edit_settings'); ?>"><i class="fa fa-wrench"></i>Edit Setting</a></li>	
                                        <li><a href="<?php echo base_url('admin/admin/changepwd_form'); ?>"><i class="fa fa-key"></i>Change Password</a></li>						
                                         <li><a href="<?php echo base_url('admin/admin/change_logo'); ?>"><i class="fa fa-refresh"></i>Change logo</a></li>
