...
class Vechicle extends Traveller_Controller 
{
    ...
    function vechicleform($id = false) 
	{
        ...
        if ($id) 
		{
            ...
            $data['vehiclenametype'] = $profile->vehicle_type;
        }
        ...
        $this->form_validation->set_rules('vehiclenametype', 'Vehicle Type', 'trim|required');
		...
		else 
		{
            ...
            $param['vehicle_type'] = $this->input->post('vehiclenametype', true);
