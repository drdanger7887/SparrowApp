...
class Traveller extends Admin_Controller {
    ...
    function form($id = false) {
        ...
        $this->form_validation->set_rules('userfirstname', 'First name', 'trim|required|max_length[250]');
        $this->form_validation->set_rules('userlastname', 'Last name', 'trim|required|max_length[250]');
