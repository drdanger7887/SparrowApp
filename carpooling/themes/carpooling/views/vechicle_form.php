...
<div class="clear"> </div>        
         <div class="margin pro-tab-cont">
          <h5><?php echo lang('vehicle_number');?></h5>
           <input type="text" placeholder="<?php echo lang('vehicle_number');?>" class="disable" name="txtvechicle" id="txtvechicle" value="<?=$txtvechicle?>" />
        </div>
      </div>
<div class="clear"> </div>
      <div class="row">
...
<div class="clear"> </div>        
      ...
      <div class="fright row size14 sea-trp-view"> 
        <p class="margintop20 fright ed-can-trp">
            ...
            <input type="Submit" class="save" value="<?php echo lang('save_button');?>" id="search_but">                  
          
            <a href="javascript:void(0)" class="back" style="color: #fff !important"> <img src="<?php echo theme_img('back-ico.png') ?>" width="12" height="12"> <?php echo lang('back');?> </a>
        </p>
      </div>
     </form>
</div>
