                ...
                <div class="obj_cont p_block_bottom rowrec" style="display: block;">
                    <div class="my-trp-tab row">
                        <div class="my-trp-main">
                            <a href="<?=base_url('addtrip/enquery_list')?>" ><?php echo lang('rides_offered');?> </a>
                            <a href="javascript:void(0)" class="trp-main-active"><?php echo lang('enquiry');?> </a>
                        </div>
                                ...
                                <?php if ($enquiries) { ?>         	
                                    <table valign="center" cellpadding="0" cellspacing="0"  width="100%">
                                        <tbody><tr class="table-front">
                                                ...
                                                <th> <?php echo lang('owner_number'); ?> </th>
                                                <th> <?php echo lang('owner_email');?> </th>
                                            ...
                                            <?php foreach ($enquiries as $enquiry) { ?>
                                                ...
                                                <tr id="enquiry-<?=$enquiry->enquiry_id?>">                        	
                                                    ...
                                                    <td> <?= ($enquiry->enquiry_trip_status == 0)?'----':$enquiry->user_mobile ?> </td>                           
                                                    <td class="lst"> <?= ($enquiry->enquiry_trip_status == 0)?'----':$enquiry->user_email ?></td>
                                                    <td id="enquirySuccess-<?=$enquiry->enquiry_id?>">
                                                        <?php if ($enquiry->enquiry_trip_status == 0){ ?>
                                                        <p> <?php echo lang('pending'); ?> </p>
                                                        <?php } else {?>                                                        
