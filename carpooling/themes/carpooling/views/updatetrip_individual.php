...
<?php } ?>
<?php echo theme_js('update_trip.js', true); ?>
                                ...
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">     
                                    <div class="trip-lft">
                                        ...
                                        <div class="fleft width100 margintop20">
                                            ...
                                            <?php
                                            $data = array('' => lang('select_vehicles'));
                                        ...
                                        <div class="fleft width100 margintop20"> 
                                            ...
                                            <p class="row bold paddingtop10">                                         
                                                <span class="fleft size14"> <input type="checkbox" name="passenger_type" id="female" value="female" <?php if($passenger_type==1){ echo 'checked';} ?>/> <?php echo lang('female'); ?> </span>
                                                <span class="fleft size14 marginleft30"> <input type="checkbox" name="passenger_type" id="male" value="male" <?php if($passenger_type==2){ echo 'checked';} ?>/> <?php echo lang('male'); ?>  </span>
                                                <span class="fleft size14 marginleft30"> <input type="checkbox" name="passenger_type" id="both" value="both" <?php if($passenger_type==3){ echo 'checked';} ?>/> <?php echo lang('both'); ?>  </span>
                                            </p><br>
