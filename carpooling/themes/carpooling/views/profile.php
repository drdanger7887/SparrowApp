...
<div class="container-fluid">
    <div class="container">
        <div class="row">
        	<ul class="profileul">
				<li><a href="<?php echo base_url('profile').'#personal-info'; ?>"><?php echo lang('personal_info'); ?></a></li>
				<li><a href="<?php echo base_url('profile').'#settings'; ?>"><?php echo lang('settings'); ?></a></li>
				<li><a href="<?php echo base_url('profile').'#my-cars-info'; ?>"><?php echo lang('my_cars'); ?></a></li>
            ...
            <div id="v-nav" >
        	    <ul class="hidden">
                    ...
                    <li tab="settings" class="second vtab">  <?php echo lang('settings'); ?></li>
                    <li tab="my-cars-info" class="third vtab">  <?php echo lang('my_cars'); ?></li>
                ...
                <div class="tab-content" style="display: block;">
                    ...
                    <div class="rowrec">
                        ...
                        <h3 class="profile-hd-tit"> <?= $customer->user_first_name ?>  <a href="javascript:void(0)" id="edit-profile"> <?php echo lang('edit_proimage'); ?> </a> </h3>
                        ...
                        <div class="hidden rowrec">
                            <div class="inner-trip-det marginbot10">
                                ...
                                <div class="padding20 rowrec">
                                    ...
                                    <div class="fleft pro-tab-cont full-width paddingtop10">
                                        <input type="text" placeholder="<?php echo lang('alter_email'); ?>" name="atxtemail" id="atxtemail" value="<?= $atxtemail ?>" />
                                    </div>                  
                                </div>
                        ...
                        <div class="rowrec">
                            <div class="inner-trip-det marginbot10">
                                ...
                                <div class="padding20 rowrec">
                                    ...
                                    <div class="margintop20 fright pro-tab-cont">
                                ...
                                <div class="padding20 rowrec">
                                    ...
                                    <h5 class="margin"><?php echo lang('birthdate'); ?></h5>
                                     ...
                                     <!-- <h5><?php echo lang('share_the_follow'); ?></h5>
                                      ...
                                      <p><label><input type="checkbox"> <?php echo lang('i_agree_to'); ?> </label> -->
                                        <div class="fright row size14 sea-trp-view"> 
                                            ...
                                            <input type="Submit" value="<?php echo lang('submit'); ?>" class="alinkbtn padchg">
