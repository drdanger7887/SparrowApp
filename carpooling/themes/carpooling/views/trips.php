            ...
            <div class="container-fluid">
                <div class="container">
                    <div class="fleft width100 margin">
                        ...
                        <h1 class="upper center"><?php echo lang('my_trips'); ?></h1>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="inner-trip-det">
                                        ...
                                        <div id="slide<?= $i ?>" style="display:none">
                                                        ...
                                                        <div class="inner-trip-det marginbot10">
                                                            ...
                                                            <div class="padding20 fleft width100">
                                                                <div class="inn-in-left fleft">
                                                                    ...
                                                                    <div class="hidden sea-city-city margintop30 row cs-grey-text size14"> 
                                                                        <img src="<?php echo theme_img('rs-ico-big.png') ?>"> <b> <?php echo lang('price'); ?> </b><?php echo $this->config->item('currency_symbol'); ?> <span class="grey" id="amount_<?= $trip_leg['trip_led_id'] ?>"> <?php
                                                                        //var_dump($trip_leg);
                                                                            if (!empty($trip_leg['route_rate'])) {
                                                                                echo $trip_leg['route_rate'];
                                                                            } else {
                                                                                echo '-';
                                                                            }
                                                                            ?>                                                                           
                                                                ...
                                                                <div class="inn-in-left fright flefti margintop20i">
                                                                    <div class="hidden sea-city-city fright fleftnon cs-grey-text size14 ed-tme"> 
                                                                    ...
                                                                    <div class="hidden sea-city-city fright cs-grey-text size14 ed-tme" style="clear:both"> 
                                                                        <b><?php echo lang('edit_rate'); ?></b>
                                                                        <div id="edit-rate-<?= $trip_leg['trip_led_id'] ?>" style="display:none">
                                                                            <?php
                                                                            $fresult = $trip_leg['route_rate'];
                                                                            $data = array('name' => 'route_rate', 'id' => 'rate' . $trip_leg['trip_led_id'], 'class' => 'rate' . $trip_leg['trip_led_id'], 'placeholder' => lang('trip_rate'), 'value' => set_value('avail_seats', $fresult));
                                            ...
                                            <div class="fleft width100 padding20 ed-can-trp">
                                                ...
                                                <?php $enq = checkorder($trip['trip_id'],$trip['user_id']);?>
                                                <?php if($enq){
                                                    if(checkorder($trip['trip_id'],$trip['user_id'])){?> 
                                                    <div class="clear"> </div><a style="display: block; margin: 5px 0;" href="<?= base_url('addtrip/delete/' . $trip['trip_id']); ?>" class="red-bg"> <img src="<?php echo theme_img('cancel-ico.png') ?>"> <?php echo lang('delete_all_trips'); ?> </a> 
                                                    <div class="clear"> </div>
                                                    <a class="alinkbtn" style="display: block; margin: 5px 0;" href="<?= base_url('addtrip/update_trip/' . $trip['trip_id']); ?>"> <img src="<?php echo theme_img('edit-ico.png') ?>"><?php echo lang('edit_trips'); ?></a><div class="clear"> </div>
                                                <?php }  } else{ ?>
