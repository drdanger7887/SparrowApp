            ...
            <div class="sea-col3">
              ...
              <?php
                    if($search_result['trip_casual_date']){
                        echo getAvailableSeat(date("d-m-Y", strtotime($search_result['trip_casual_date'])),$search_result['trip_id']);
                    }else{
                        echo getAvailableSeat(date('d-m-Y',  strtotime(str_replace('/', '-', $selparam['date']))),$search_result['trip_id']);
                    }
