...
class Dashboard extends Admin_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('Customer_model','payment_model','Travel_model','Trip_model','Vehicles_model','subscribe_model','enquiry_model','testimonial_model','category_model'));
	...
	function index()
	{
		...
		$data['total_categories'] = $this->category_model->count_categories(); 
                $data['total_amount'] = $this->payment_model->total_payment_amount();
