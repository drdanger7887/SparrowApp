...
$config['user_language']				= '<?php echo $user_language;?>';

$config['payment_commission']			= '<?php echo $payment_commission;?>';
$config['payment_status']				= '<?php echo $payment_status;?>';
$config['google_api_key']				= '<?php echo $google_api_key;?>';
