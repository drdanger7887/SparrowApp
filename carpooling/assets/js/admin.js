$(document).ready(function () {
    ...
    $('body').on('change', '#advertisementimg', function ()
    {
        var values = $("#uploadvalues").val();
        $("#previeww").html('<img src="http://localhost/vehicle/vehicle/themes/vehicle/assets/img/loader.gif"/>');
        $("#advertisementimageform").ajaxForm({target: '#preview',
            beforeSubmit: function () {
                $("#imageloadstatus").show();
                $("#imageloadbutton").hide();
            },
    ...
    $('body').on('change', '#comportimg', function ()
    {
        var values = $("#uploadvalues").val();
        $("#previeww").html('<img src="http://localhost/vehicle/vehicle/themes/comport/assets/img/loader.gif"/>');
        $("#comportimageform").ajaxForm({target: '#preview',
            beforeSubmit: function () {
                $("#imageloadstatus").show();
                $("#imageloadbutton").hide();
            },
    ...
    $('body').on('click', '#cameraad', function ()
    {
        $("#advertisementimg").trigger("click");
    });

    $('body').on('click', '#cameracomport', function ()
    {
        $("#comportimg").trigger("click");
    });
    ...
    $('body').on('click', '#advertisement-img-remove', function ()
    {
        if (confirm('Conform to delete image'))
        {
            var img_name = $("input[name=uploadvalues]").val();
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "admin/advertisement/delete_image",
                data: dataString,
                cache: false,
                //beforeSend: function(){$("#friendstatus").html($.loaderIcon); },
                success: function (html)
                {
                    ...
                    {
                        setTimeout(function () {
                            $(".advertisementimage").fadeOut("slow");
                            $("#uploadlink").fadeIn();
                            $("input[name=uploadvalues]").val('');
                        }, 1000);
                        setTimeout(function () {
                            $(".advertisementimage").remove();
                        }, 1500);
    ...
    $('body').on('click', '#comport-img-remove', function ()
    {
        if (confirm('Conform to delete image'))
        {
            var img_name = $("input[name=uploadvalues]").val();
            ...
            $.ajax({
                type: "POST",
                url: baseurl + "admin/comport_level/delete_image",
                data: dataString,
                cache: false,
                //beforeSend: function(){$("#friendstatus").html($.loaderIcon); },
                success: function (html)
